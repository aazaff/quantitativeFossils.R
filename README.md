...
+ v0.035 - Optimized the ````presenceMatrix( )```` and ````abundanceMatrix( )```` functions. It now produces an identical output at 100x the speed. The arguments have been changed to make it clearer what makes up the rows and columns of the matrix.
